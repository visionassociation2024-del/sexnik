    ...
    modal.innerHTML = `
      <div class="age-gate-card">
        ...
        <h2 class="age-gate-title">
          مرحباً بك في <span>وقاية برو</span>
        </h2>
        
        <div class="age-gate-desc">
          <p style="margin-bottom: 10px;">
            أنت على وشك الدخول إلى منصة <strong>وقاية برو (Weqaya Pro)</strong> المتخصصة في فهرسة وبث مقاطع الفيديو الترفيهية المخصصة حصرياً للبالغين.
          </p>
